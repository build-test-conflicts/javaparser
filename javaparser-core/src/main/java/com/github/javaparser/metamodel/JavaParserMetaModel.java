...
public final class JavaParserMetaModel {
  ...
  private static List<BaseNodeMetaModel> nodeMetaModels=new ArrayList<>();
  ...
  public static void initializeNodeMetaModels(){
  ...
  public static NodeMetaModel nodeMetaModel=new NodeMetaModel(Optional.empty());
  public static BodyDeclarationMetaModel bodyDeclarationMetaModel=new BodyDeclarationMetaModel(Optional.of(nodeMetaModel));
  public static CallableDeclarationMetaModel callableDeclarationMetaModel=new CallableDeclarationMetaModel(Optional.of(bodyDeclarationMetaModel));
  public static StatementMetaModel statementMetaModel=new StatementMetaModel(Optional.of(nodeMetaModel));
  public static ExpressionMetaModel expressionMetaModel=new ExpressionMetaModel(Optional.of(nodeMetaModel));
  public static TypeMetaModel typeMetaModel=new TypeMetaModel(Optional.of(nodeMetaModel));
  public static AnnotationExprMetaModel annotationExprMetaModel=new AnnotationExprMetaModel(Optional.of(expressionMetaModel));
  public static TypeDeclarationMetaModel typeDeclarationMetaModel=new TypeDeclarationMetaModel(Optional.of(bodyDeclarationMetaModel));
  public static ReferenceTypeMetaModel referenceTypeMetaModel=new ReferenceTypeMetaModel(Optional.of(typeMetaModel));
  public static LiteralExprMetaModel literalExprMetaModel=new LiteralExprMetaModel(Optional.of(expressionMetaModel));
  public static LiteralStringValueExprMetaModel literalStringValueExprMetaModel=new LiteralStringValueExprMetaModel(Optional.of(literalExprMetaModel));
  public static StringLiteralExprMetaModel stringLiteralExprMetaModel=new StringLiteralExprMetaModel(Optional.of(literalStringValueExprMetaModel));
  public static ModuleDeclarationMetaModel moduleDeclarationMetaModel=new ModuleDeclarationMetaModel(Optional.of(nodeMetaModel));
  public static ModuleDirectiveMetaModel moduleDirectiveMetaModel=new ModuleDirectiveMetaModel(Optional.of(nodeMetaModel));
  public static ArrayCreationLevelMetaModel arrayCreationLevelMetaModel=new ArrayCreationLevelMetaModel(Optional.of(nodeMetaModel));
  public static CompilationUnitMetaModel compilationUnitMetaModel=new CompilationUnitMetaModel(Optional.of(nodeMetaModel));
  public static PackageDeclarationMetaModel packageDeclarationMetaModel=new PackageDeclarationMetaModel(Optional.of(nodeMetaModel));
  public static ModifierMetaModel modifierMetaModel=new ModifierMetaModel(Optional.of(nodeMetaModel));
  public static AnnotationDeclarationMetaModel annotationDeclarationMetaModel=new AnnotationDeclarationMetaModel(Optional.of(typeDeclarationMetaModel));
  public static AnnotationMemberDeclarationMetaModel annotationMemberDeclarationMetaModel=new AnnotationMemberDeclarationMetaModel(Optional.of(bodyDeclarationMetaModel));
  public static ClassOrInterfaceDeclarationMetaModel classOrInterfaceDeclarationMetaModel=new ClassOrInterfaceDeclarationMetaModel(Optional.of(typeDeclarationMetaModel));
  public static ConstructorDeclarationMetaModel constructorDeclarationMetaModel=new ConstructorDeclarationMetaModel(Optional.of(callableDeclarationMetaModel));
  public static EnumConstantDeclarationMetaModel enumConstantDeclarationMetaModel=new EnumConstantDeclarationMetaModel(Optional.of(bodyDeclarationMetaModel));
  public static EnumDeclarationMetaModel enumDeclarationMetaModel=new EnumDeclarationMetaModel(Optional.of(typeDeclarationMetaModel));
  public static FieldDeclarationMetaModel fieldDeclarationMetaModel=new FieldDeclarationMetaModel(Optional.of(bodyDeclarationMetaModel));
  public static InitializerDeclarationMetaModel initializerDeclarationMetaModel=new InitializerDeclarationMetaModel(Optional.of(bodyDeclarationMetaModel));
  public static MethodDeclarationMetaModel methodDeclarationMetaModel=new MethodDeclarationMetaModel(Optional.of(callableDeclarationMetaModel));
  public static ParameterMetaModel parameterMetaModel=new ParameterMetaModel(Optional.of(nodeMetaModel));
  public static ReceiverParameterMetaModel receiverParameterMetaModel=new ReceiverParameterMetaModel(Optional.of(nodeMetaModel));
  public static VariableDeclaratorMetaModel variableDeclaratorMetaModel=new VariableDeclaratorMetaModel(Optional.of(nodeMetaModel));
  public static CommentMetaModel commentMetaModel=new CommentMetaModel(Optional.of(nodeMetaModel));
  public static BlockCommentMetaModel blockCommentMetaModel=new BlockCommentMetaModel(Optional.of(commentMetaModel));
  public static JavadocCommentMetaModel javadocCommentMetaModel=new JavadocCommentMetaModel(Optional.of(commentMetaModel));
  public static LineCommentMetaModel lineCommentMetaModel=new LineCommentMetaModel(Optional.of(commentMetaModel));
  public static ArrayAccessExprMetaModel arrayAccessExprMetaModel=new ArrayAccessExprMetaModel(Optional.of(expressionMetaModel));
  public static ArrayCreationExprMetaModel arrayCreationExprMetaModel=new ArrayCreationExprMetaModel(Optional.of(expressionMetaModel));
  public static ArrayInitializerExprMetaModel arrayInitializerExprMetaModel=new ArrayInitializerExprMetaModel(Optional.of(expressionMetaModel));
  public static AssignExprMetaModel assignExprMetaModel=new AssignExprMetaModel(Optional.of(expressionMetaModel));
  public static BinaryExprMetaModel binaryExprMetaModel=new BinaryExprMetaModel(Optional.of(expressionMetaModel));
  public static BooleanLiteralExprMetaModel booleanLiteralExprMetaModel=new BooleanLiteralExprMetaModel(Optional.of(literalExprMetaModel));
  public static CastExprMetaModel castExprMetaModel=new CastExprMetaModel(Optional.of(expressionMetaModel));
  public static CharLiteralExprMetaModel charLiteralExprMetaModel=new CharLiteralExprMetaModel(Optional.of(literalStringValueExprMetaModel));
  public static ClassExprMetaModel classExprMetaModel=new ClassExprMetaModel(Optional.of(expressionMetaModel));
  public static ConditionalExprMetaModel conditionalExprMetaModel=new ConditionalExprMetaModel(Optional.of(expressionMetaModel));
  public static DoubleLiteralExprMetaModel doubleLiteralExprMetaModel=new DoubleLiteralExprMetaModel(Optional.of(literalStringValueExprMetaModel));
  public static EnclosedExprMetaModel enclosedExprMetaModel=new EnclosedExprMetaModel(Optional.of(expressionMetaModel));
  public static FieldAccessExprMetaModel fieldAccessExprMetaModel=new FieldAccessExprMetaModel(Optional.of(expressionMetaModel));
  public static InstanceOfExprMetaModel instanceOfExprMetaModel=new InstanceOfExprMetaModel(Optional.of(expressionMetaModel));
  public static IntegerLiteralExprMetaModel integerLiteralExprMetaModel=new IntegerLiteralExprMetaModel(Optional.of(literalStringValueExprMetaModel));
  public static LambdaExprMetaModel lambdaExprMetaModel=new LambdaExprMetaModel(Optional.of(expressionMetaModel));
  public static LongLiteralExprMetaModel longLiteralExprMetaModel=new LongLiteralExprMetaModel(Optional.of(literalStringValueExprMetaModel));
  public static MarkerAnnotationExprMetaModel markerAnnotationExprMetaModel=new MarkerAnnotationExprMetaModel(Optional.of(annotationExprMetaModel));
  public static MemberValuePairMetaModel memberValuePairMetaModel=new MemberValuePairMetaModel(Optional.of(nodeMetaModel));
  public static MethodCallExprMetaModel methodCallExprMetaModel=new MethodCallExprMetaModel(Optional.of(expressionMetaModel));
  public static MethodReferenceExprMetaModel methodReferenceExprMetaModel=new MethodReferenceExprMetaModel(Optional.of(expressionMetaModel));
  public static NameExprMetaModel nameExprMetaModel=new NameExprMetaModel(Optional.of(expressionMetaModel));
  public static NameMetaModel nameMetaModel=new NameMetaModel(Optional.of(nodeMetaModel));
  public static NormalAnnotationExprMetaModel normalAnnotationExprMetaModel=new NormalAnnotationExprMetaModel(Optional.of(annotationExprMetaModel));
  public static NullLiteralExprMetaModel nullLiteralExprMetaModel=new NullLiteralExprMetaModel(Optional.of(literalExprMetaModel));
  public static ObjectCreationExprMetaModel objectCreationExprMetaModel=new ObjectCreationExprMetaModel(Optional.of(expressionMetaModel));
  public static SimpleNameMetaModel simpleNameMetaModel=new SimpleNameMetaModel(Optional.of(nodeMetaModel));
  public static SingleMemberAnnotationExprMetaModel singleMemberAnnotationExprMetaModel=new SingleMemberAnnotationExprMetaModel(Optional.of(annotationExprMetaModel));
  public static SuperExprMetaModel superExprMetaModel=new SuperExprMetaModel(Optional.of(expressionMetaModel));
  public static TextBlockLiteralExprMetaModel textBlockLiteralExprMetaModel=new TextBlockLiteralExprMetaModel(Optional.of(literalStringValueExprMetaModel));
  public static ThisExprMetaModel thisExprMetaModel=new ThisExprMetaModel(Optional.of(expressionMetaModel));
  public static TypeExprMetaModel typeExprMetaModel=new TypeExprMetaModel(Optional.of(expressionMetaModel));
  public static UnaryExprMetaModel unaryExprMetaModel=new UnaryExprMetaModel(Optional.of(expressionMetaModel));
  public static VariableDeclarationExprMetaModel variableDeclarationExprMetaModel=new VariableDeclarationExprMetaModel(Optional.of(expressionMetaModel));
  public static SwitchExprMetaModel switchExprMetaModel=new SwitchExprMetaModel(Optional.of(expressionMetaModel));
  public static ImportDeclarationMetaModel importDeclarationMetaModel=new ImportDeclarationMetaModel(Optional.of(nodeMetaModel));
  public static AssertStmtMetaModel assertStmtMetaModel=new AssertStmtMetaModel(Optional.of(statementMetaModel));
  public static BlockStmtMetaModel blockStmtMetaModel=new BlockStmtMetaModel(Optional.of(statementMetaModel));
  public static BreakStmtMetaModel breakStmtMetaModel=new BreakStmtMetaModel(Optional.of(statementMetaModel));
  public static CatchClauseMetaModel catchClauseMetaModel=new CatchClauseMetaModel(Optional.of(nodeMetaModel));
  public static ContinueStmtMetaModel continueStmtMetaModel=new ContinueStmtMetaModel(Optional.of(statementMetaModel));
  public static DoStmtMetaModel doStmtMetaModel=new DoStmtMetaModel(Optional.of(statementMetaModel));
  public static EmptyStmtMetaModel emptyStmtMetaModel=new EmptyStmtMetaModel(Optional.of(statementMetaModel));
  public static ExplicitConstructorInvocationStmtMetaModel explicitConstructorInvocationStmtMetaModel=new ExplicitConstructorInvocationStmtMetaModel(Optional.of(statementMetaModel));
  public static ExpressionStmtMetaModel expressionStmtMetaModel=new ExpressionStmtMetaModel(Optional.of(statementMetaModel));
  public static ForEachStmtMetaModel forEachStmtMetaModel=new ForEachStmtMetaModel(Optional.of(statementMetaModel));
  public static ForStmtMetaModel forStmtMetaModel=new ForStmtMetaModel(Optional.of(statementMetaModel));
  public static IfStmtMetaModel ifStmtMetaModel=new IfStmtMetaModel(Optional.of(statementMetaModel));
  public static LabeledStmtMetaModel labeledStmtMetaModel=new LabeledStmtMetaModel(Optional.of(statementMetaModel));
  public static ReturnStmtMetaModel returnStmtMetaModel=new ReturnStmtMetaModel(Optional.of(statementMetaModel));
  public static SwitchEntryMetaModel switchEntryMetaModel=new SwitchEntryMetaModel(Optional.of(nodeMetaModel));
  public static SwitchStmtMetaModel switchStmtMetaModel=new SwitchStmtMetaModel(Optional.of(statementMetaModel));
  public static SynchronizedStmtMetaModel synchronizedStmtMetaModel=new SynchronizedStmtMetaModel(Optional.of(statementMetaModel));
  public static ThrowStmtMetaModel throwStmtMetaModel=new ThrowStmtMetaModel(Optional.of(statementMetaModel));
  public static TryStmtMetaModel tryStmtMetaModel=new TryStmtMetaModel(Optional.of(statementMetaModel));
  public static LocalClassDeclarationStmtMetaModel localClassDeclarationStmtMetaModel=new LocalClassDeclarationStmtMetaModel(Optional.of(statementMetaModel));
  public static WhileStmtMetaModel whileStmtMetaModel=new WhileStmtMetaModel(Optional.of(statementMetaModel));
  public static YieldStmtMetaModel yieldStmtMetaModel=new YieldStmtMetaModel(Optional.of(statementMetaModel));
  public static UnparsableStmtMetaModel unparsableStmtMetaModel=new UnparsableStmtMetaModel(Optional.of(statementMetaModel));
  public static ArrayTypeMetaModel arrayTypeMetaModel=new ArrayTypeMetaModel(Optional.of(referenceTypeMetaModel));
  public static ClassOrInterfaceTypeMetaModel classOrInterfaceTypeMetaModel=new ClassOrInterfaceTypeMetaModel(Optional.of(referenceTypeMetaModel));
  public static IntersectionTypeMetaModel intersectionTypeMetaModel=new IntersectionTypeMetaModel(Optional.of(typeMetaModel));
  public static PrimitiveTypeMetaModel primitiveTypeMetaModel=new PrimitiveTypeMetaModel(Optional.of(typeMetaModel));
  public static TypeParameterMetaModel typeParameterMetaModel=new TypeParameterMetaModel(Optional.of(referenceTypeMetaModel));
  public static UnionTypeMetaModel unionTypeMetaModel=new UnionTypeMetaModel(Optional.of(typeMetaModel));
  public static UnknownTypeMetaModel unknownTypeMetaModel=new UnknownTypeMetaModel(Optional.of(typeMetaModel));
  public static VoidTypeMetaModel voidTypeMetaModel=new VoidTypeMetaModel(Optional.of(typeMetaModel));
  public static WildcardTypeMetaModel wildcardTypeMetaModel=new WildcardTypeMetaModel(Optional.of(typeMetaModel));
  public static VarTypeMetaModel varTypeMetaModel=new VarTypeMetaModel(Optional.of(typeMetaModel));
  public static ModuleRequiresDirectiveMetaModel moduleRequiresDirectiveMetaModel=new ModuleRequiresDirectiveMetaModel(Optional.of(moduleDirectiveMetaModel));
  public static ModuleExportsDirectiveMetaModel moduleExportsDirectiveMetaModel=new ModuleExportsDirectiveMetaModel(Optional.of(moduleDirectiveMetaModel));
