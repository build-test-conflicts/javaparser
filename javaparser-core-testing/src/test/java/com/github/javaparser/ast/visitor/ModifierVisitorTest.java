...
class ModifierVisitorTest {
  @Test void makeSureParentListsCanBeModified(){
    ...
    list.accept(new ModifierVisitor<Void>(){
      @Override public Visitable visit(      final StringLiteralExpr n,      final Void arg){
        String v=n.getValue();
...
,null);
  ...
  @Test void binaryExprReturnsLeftExpressionWhenRightSideIsRemoved(){
...
,null);
  ...
  @Test void binaryExprReturnsRightExpressionWhenLeftSideIsRemoved(){
...
,null);
  ...
  @Test void fieldDeclarationCantSurviveWithoutVariables(){
...
,null);
  ...
  @Test void variableDeclarationCantSurviveWithoutVariables(){
