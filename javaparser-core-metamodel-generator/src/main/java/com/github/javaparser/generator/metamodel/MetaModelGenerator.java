...
public class MetaModelGenerator {
  static String BASE_NODE_META_MODEL="BaseNodeMetaModel";
...
;
  ...
  public void generateNodeMetaModels(  CompilationUnit javaParserMetaModelCu,  SourceRoot sourceRoot) throws NoSuchMethodException {
  ...
  public static boolean isNode(  Class<?> c){
    return Node.class.isAssignableFrom(c);
  }
  public static String nodeMetaModelName(  Class<?> c){
  ...
  public static String nodeMetaModelFieldName(  Class<?> nodeClass){
